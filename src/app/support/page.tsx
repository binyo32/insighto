...
export const metadata: Metadata = {
  title: 'Support — Insighto',
  description: 'Get help and support for the Insighto app.',
};
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <ul className="list-disc list-inside mt-1 space-y-1">
                  <li>
                    <strong className="text-white">iOS:</strong> Settings →
                    Apple ID → Subscriptions → Insighto → Cancel
                  </li>
                  <li>
                    <strong className="text-white">Android:</strong> Google
                    Play → Payments &amp; subscriptions → Subscriptions →
                    Insighto → Cancel
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="mt-1">
                  You can delete your account from the app (Settings → Account
                  → Delete Account) or by emailing us. See our{' '}
                  <a
                    href="/delete-account"

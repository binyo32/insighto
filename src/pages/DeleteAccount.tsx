      ...
      <article className="max-w-3xl mx-auto prose-custom">
        ...
        <section className="space-y-6 text-gray-300 leading-relaxed">
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 mt-2">
              <li>
                <strong className="text-white">iOS:</strong> Settings &rarr; Apple
                ID &rarr; Subscriptions &rarr; Insighto &rarr; Cancel
              </li>
              <li>
                <strong className="text-white">Android:</strong> Google Play &rarr;
                Payments &amp; subscriptions &rarr; Subscriptions &rarr; Insighto &rarr;
                Cancel
              </li>
            </ul>
          </div>

...
const tiers = [
  ...
  },
  {
    ...
    price: '$12.99',
    period: '/month',
    desc: '5x more searches a day with full profile access.',
    features: [
      '5x more searches a day',
      'Full profile access',
  ...
  },
  {
    ...
    price: '$19.99',
    period: '/month',
    desc: '25x more searches a day with full access to everything.',
    features: [
      '25x more searches a day',
      'Everything in Pro',
      'Maximum daily quota',
